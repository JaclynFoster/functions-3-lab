...
numbers.forEach(num => {
  num /= 2
  console.log('Numbers divided by 2: ', num)
})
/// /////// PROBLEM 2 //////////
...
// CODE HERE
const endsWithI = cities.filter(city => {
  return city.endsWith('i')
})
console.log('Ends with I: ', endsWithI)
/// /////// PROBLEM 4 //////////
...
/*
    Using forEach method, identify each element of the 'fruits' array above if it's an apple
     or orange by its color. If the color is red, print "The fruit with index [THE ELEMENT'S INDEX]
    is an apple." If the color is orange, print "The fruit with index [THE ELEMENT INDEX] is an orange."
   If the color is not red or apple, print "The fruit with index [THE ELEMENT'S INDEX] is neither apple
   or orange."
